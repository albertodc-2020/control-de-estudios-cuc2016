...
<div id="apDiv3">
 ...
 <p class="font2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ingresar datos de Representante</p>
...
<label for="nacionalidad" class="font2"><span class="font2">Nacionalidad:&nbsp;</span></label>
    ...
    <p class="font2"><label for="parentesco">&nbsp;Parentesco:</label>  <input name="parentesco" id="parentesco" size="20"/><label for="ocupacion">&nbsp;Ocupación:</label>  <input name="ocupacion" id="ocupacion" size="20"/> 
  </p>
    <p class="font2">
