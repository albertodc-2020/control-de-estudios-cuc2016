...
<div id="apDiv1">
  <ul id="MenuBar1" class="MenuBarVertical">
     <li><a href=".\gest_alum.php">Gestionar Alumno</a></li>
    <li><a href="" class="MenuBarItemSubmenu">Gestionar Personal</a>
      <ul>
        <li><a href=".\gest_doc.php">Docente</a></li>
        <li><a href=".\gest_per.php">Administrativo</a></li>
      </ul>
    </li>
...
<div id="apDiv3">
    ...
    <p class="font2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ingresar datos de Personal Administrativo</p>
    <p>&nbsp;</p>
...
<label for="nacionalidad" class="font2"><span class="font2">Nacionalidad:&nbsp;</span></label>
   ...
   <p class="font2"><label for="edo_civil" class="font2"><span class="font2">&nbsp;Estado Civil:&nbsp;</span></label>
      <input type="text" name="edo_civil" size="20"id="edo_civil" /> <label for="telefono" class="font2"><span class="font2">&nbsp;Telefono:&nbsp;</span></label>
      <input type="text" name="telefono" size="30"id="telefono" /></p>
 <p class="font2"><label for="profesion" class="font2"><span class="font2">&nbsp;Profesión:&nbsp;</span></label>
      <input type="text" name="profesion" size="30"id="profesion" />
    ...
    <p class="font2">
      ...
      <center>
        ...
        <input type="submit" name="Guardar" id="Guardar" value="Guardar" /> </center>
      </label>
    </p>
    <p class="font2">&nbsp;</p>
    <p class="font2">&nbsp;</p>
