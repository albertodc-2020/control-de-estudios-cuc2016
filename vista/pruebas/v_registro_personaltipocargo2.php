...
<div id="apDiv3">
 ...
 <p class="font2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tipo de Cargo</p>
<p class="font2">&nbsp;</p>
  <p class="font2"> <label for="perfil">&nbsp;Perfil del Empleado:</label><input type="text" name="perfil" size="80" id="perfil" /></p>
     
    <p class="font2">
  <label for="turnotrabajo">&nbsp;Turno de Trabajo:&nbsp;&nbsp;</label><input name="turnotrabajo" id="turnotrabajo" size="10"/></p>
    <p class="font2">
      <label for="sexo">&nbsp;</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
    <p class="font2">
